...
public class BaiduPushReceiver extends PushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        if (errorCode == 0) {
            // 绑定成功
//            BaseActivity.baiduPushChannelid = channelId;
            BaseActivity.device_token = channelId;
            SharedPreferencesUtils.setValue(context,"device_token",""+channelId);
//            SharedPreferencesUtils.setValue(context,"channelId",""+channelId);
        }

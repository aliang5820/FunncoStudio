 ...
 */
public class SortAdapterDate extends BaseAdapter{
...
//    private VolleyUtils util;
    ...
    public SortAdapterDate(Context mContext, List<MyCustomerDate> list, Post post,ImageLoader imageLoader,DisplayImageOptions options) {
...
//        util = new VolleyUtils(mContext);
     ...
     * @param list
     */
    public void updateListView(List<MyCustomerDate> list){
        this.list = list;
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        final MyCustomerDate mContent = list.get(position);
        if (view == null) {
        ...
        imageLoader.displayImage(list.get(position).getHeadpic(),viewHolder.ivIcon);
        //打上标记

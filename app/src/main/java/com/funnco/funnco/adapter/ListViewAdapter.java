...
//		}
    ...
    public void fillValues(int position, View convertView) {
        ...
        List<FunncoEventCustomer> eventCustomers = funncoEvent.getList();
        ...
        tvTime.setText(time);
        ImageView service_img = (ImageView) convertView.findViewById(R.id.service_img);
        ...
        if (number.equals("0")) {
            ...
            imageLoader.displayImage(funncoEvent.getHeadpic(), service_img);
        } else {
            imageLoader.displayImage(funncoEvent.getAdmin_headpic(), service_img);
            ...
            if (eventCustomers != null) {
                tvConventionNumber.setText("" + eventCustomers.size() + "/" + count);
                int remarkNumber = 0;
                for (int i = 0; i < eventCustomers.size(); i++) {
                    FunncoEventCustomer fec = eventCustomers.get(i);
                    if (fec != null) {

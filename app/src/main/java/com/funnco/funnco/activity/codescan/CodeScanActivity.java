package com.funnco.funnco.activity.codescan;
...
@SuppressLint("NewApi")
public class CodeScanActivity extends BaseActivity implements Callback, View.OnClickListener {
    ...
    protected void loadLayout() {
        super.loadLayout();
        parentView = getLayoutInflater().inflate(R.layout.activity_codescan_layout, null);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case PARSE_BARCODE_FAIL:
                    Toast.makeText(CodeScanActivity.this, (String) msg.obj, Toast.LENGTH_LONG).show();
                    break;

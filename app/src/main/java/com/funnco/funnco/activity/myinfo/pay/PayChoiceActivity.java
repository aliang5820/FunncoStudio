package com.funnco.funnco.activity.myinfo.pay;
 ...
 */
public class PayChoiceActivity extends BaseActivity implements PayResultCallBack {
        ...
        AsyTask task = new AsyTask(map, new DataBack() {
            ...
            public void getString(String result) {
                ...
                if (JsonUtils.getResponseCode(result) == 0) {
                    ...
                    Intent intent = new Intent(PayChoiceActivity.this, PaymentActivity.class);

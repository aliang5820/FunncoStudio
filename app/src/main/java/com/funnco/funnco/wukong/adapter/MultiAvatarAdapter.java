...
import com.funnco.funnco.adapter.CustomGridAdapter;
import com.funnco.funnco.utils.support.FunncoUtils;
import com.funnco.funnco.wukong.impl.AvatarImageDecoder;
...
//		setBlockSize(AndTools.dp2px(context, 21), AndTools.dp2px(context, 21));
		setSpace(FunncoUtils.dp2px(mContext, 1), FunncoUtils.dp2px(mContext, 1));
	}
    ...
    public void setColumnNum(int num) {
        ...
        if(1 == num) {
            setBlockSize(FunncoUtils.dp2px(mContext, 50), FunncoUtils.dp2px(mContext, 50));
        }else if (2 == num) {
            setBlockSize(FunncoUtils.dp2px(mContext, 24), FunncoUtils.dp2px(mContext, 24));
        }else{
            setBlockSize(FunncoUtils.dp2px(mContext, 16), FunncoUtils.dp2px(mContext, 16));
        }
    }

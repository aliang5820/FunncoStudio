...
//                    holder.mInMyContact.setVisibility(View.VISIBLE);
            ...
            if ((mData.get(position) != null)
                ...
                if (mData.get(position).gender.equals("M")) {
                    holder.mGenderImageView.setBackgroundResource(R.mipmap.male_userprofile);
                } else if(mData.get(position).gender.equals("F"))  {
                    holder.mGenderImageView.setBackgroundResource(R.mipmap.female_userprofile);
                } else{
            ...
            if(TextUtils.isEmpty(title)) {
                holder.mTitle.setHeight(FunncoUtils.dp2px(mContext, 150));

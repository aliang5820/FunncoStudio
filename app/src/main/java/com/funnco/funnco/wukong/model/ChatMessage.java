...
import com.funnco.funnco.wukong.viewholder.ChatViewHolder;
...
//        return mMessage.messageId() + "";
    ...
    public boolean isReceive() {
        return mMessage.senderId() == FunncoUtils.currentOpenId();
    }
    ...
    public void onShow(Context context, ChatViewHolder viewHolder,String tag) {
        if(isShowCreateTime(this)){
            ...
            viewHolder.chatting_time_tv.setText(DateUtils.formatRimetShowTime(context, mMessage.createdAt(), true));
        }else{

...
public class SessionViewHolder extends ViewHolder {
    ...
    public void showSessionStatusFail(){
        mMessageStatus.setBackgroundResource(R.mipmap.session_status_failed);
        mMessageStatus.setVisibility(View.VISIBLE);
    }

    public void showSessionStatusSending(){
        mMessageStatus.setBackgroundResource(R.mipmap.session_status_sending);
        mMessageStatus.setVisibility(View.VISIBLE);
    }
    ...
    public void showTime(long time) {
        if (time==0) {
            ...
            sessionGmtTxt.setText(DateUtils.formatRimetShowTime(sessionContentTxt.getContext(), time, false));
        }
    }
}

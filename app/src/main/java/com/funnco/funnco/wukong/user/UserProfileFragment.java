...
/**
 * Created by shuangxi on 14/12/26.
 */
@TargetApi(11)
public class UserProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.tv_headcommon_headl).setOnClickListener(clickListener);
    ...
    private void updateUserData(){
        ...
        if(mUserProfile.isActive()) {
            ...
            userProfileItemObject.imageResId = R.mipmap.avatar_in_active;
        }
    ...
    private void loadUserData() {
        if(mUserService == null || (mOpenId == null && mMobile == null)
            ...
            return;
        if(mOpenId != null) {
            FunncoUtils.showProgressDialog(getActivity(), getActivity().getString(R.string.profile_data_loading));
            mUserService.getUser(new Callback<User>() {
                ...
                public void onException(String code, String reason) {
                    FunncoUtils.dismissProgressDialog();
                    FunncoUtils.showToast(getActivity(), reason);
                    getActivity().finish();
                }
    ...
    public void createSingleConversation(){
        FunncoUtils.showProgressDialog(getActivity(), "正在创建会话...");
        IMEngine.getIMService(ConversationService.class).createConversation(new Callback<Conversation>() {
            ...
            public void onException(String code, String reason) {
                FunncoUtils.dismissProgressDialog();
                FunncoUtils.showToast(getActivity(), R.string.chat_create_fail);
                Log.e(TAG,

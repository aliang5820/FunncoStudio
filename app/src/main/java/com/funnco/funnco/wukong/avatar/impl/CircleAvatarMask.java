...
/**
 * Description.
 * DST MODE:it will work only in a transparent Bitmap or in layer
...
public class CircleAvatarMask implements AvatarMask {
    ...
    private void initPaints(){
        ...
        mDrawPaint.setXfermode(new PorterDuffXfermode(Mode.SRC_ATOP));
...
//        canvas.drawRoundRect(rect, r/2, r/2, paint);
        ...
        mMaskPaint.setXfermode(new PorterDuffXfermode(Mode.XOR));

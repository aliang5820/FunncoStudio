package com.funnco.funnco.wukong.impl;
...
import com.funnco.funnco.wukong.adapter.MultiAvatarAdapter;
import com.funnco.funnco.wukong.avatar.AvatarMagician;
import com.funnco.funnco.wukong.avatar.AvatarMask;
import com.funnco.funnco.wukong.avatar.AvatarShaper;
import com.funnco.funnco.wukong.avatar.impl.CircleAvatarMask;
import com.funnco.funnco.wukong.avatar.impl.CircleAvatarShaper;
import com.funnco.funnco.wukong.avatar.impl.RoundRectAvatarMask;
import com.funnco.funnco.wukong.avatar.impl.RoundRectAvatarShaper;
...
/**
 * @ Description:
 * @ Created by zhongqian.wzq on 2014/12/4 1:45.
 * @ Version V1.0
 */
...
//            });
        ...
        mDefaultAvatar = BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.avatar_in_active);

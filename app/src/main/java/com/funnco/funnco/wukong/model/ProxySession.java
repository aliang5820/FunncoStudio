...
public class ProxySession implements Conversation {
    ...
    @Override
    public void updateOwner(long l, Message message, Callback<Void> callback) {
    ...
    @Override
    public void sendTypingEvent(TypingCommand typingCommand, TypingType typingType) {

    }

    @Override
    public void setOnlyOwnerModifiable(boolean b, Callback<Void> callback) {
    ...
    @Override
    public void updateNotificationSound(String s) {

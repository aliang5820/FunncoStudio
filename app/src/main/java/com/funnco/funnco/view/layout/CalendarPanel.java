 ...
 */
public class CalendarPanel extends LinearLayout {
    /**
    ...
    public static interface OnPanelListener {
         ...
         */
        public void onPanelClosed(CalendarPanel calendarPanel);

        /**
         * Invoked when the panel becomes fully opened.
         */
        public void onPanelOpened(CalendarPanel calendarPanel);
    }
    //是否收缩
...
//    private Drawable mClosedHandle;
    ...
    public CalendarPanel(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.CalendarPanel);
        mDuration = a
                .getInteger(R.styleable.CalendarPanel_animationDuration, 5); // duration
        // defaults
        // to
        // 750
        // ms
        mPosition = a.getInteger(R.styleable.CalendarPanel_position, BOTTOM); // position
        // defaults
        // to
        // BOTTOM
        mLinearFlying = a.getBoolean(R.styleable.CalendarPanel_linearFlying,
                false); // linearFlying
        // defaults
        // to
        // false
//        mOpenedHandle = a.getDrawable(R.styleable.CalendarPanel_openedHandle);
//        mClosedHandle = a.getDrawable(R.styleable.CalendarPanel_closedHandle);
        a.recycle();
     ...
     * open/close.
     * 
     * @param onPanelListener The listener to be notified when the panel is
     *            opened/closed.
     */
    ...
    /**
     * Gets CalendarPanel's mHandle
     * 
     * @return CalendarPanel's mHandle
     */
...
//    }
    ...
    /**
     * Gets CalendarPanel's mContent
     * 
     * @return CalendarPanel's mContent
     */
    ...
    /**
     * Set the opened state of CalendarPanel.
     * 
     * @param open True if CalendarPanel is to be opened, false if CalendarPanel
     *            is to be closed.
    ...
    /**
     * Returns the opened status for CalendarPanel.
     * 
     * @return True if CalendarPanel is opened, false otherwise.
     */
...
//                    "Your CalendarPanel must have a View whose id attribute is 'R.id.panelHandle'");
//        }
//        mHandle.setOnTouchListener(touchListener);
        ...
        if (mContent == null) {
            throw new RuntimeException(
                    "Your CalendarPanel must have a View whose id attribute is 'R.id.panelContent'");
        }
            ...
            if (mOrientation == VERTICAL) {
                ...
                if (mState == State.FLYING && mLinearFlying) {
                    ...
                    calculatedDuration = mDuration
                            * Math.abs(toYDelta - fromYDelta) / (mContentHeight+1);
                }
            } else {
...
//        }
        ...
        if (panelListener != null) {
            if (mIsShrinking) {
                panelListener.onPanelClosed(CalendarPanel.this);
            } else {
                panelListener.onPanelOpened(CalendarPanel.this);
            }
        }
    }

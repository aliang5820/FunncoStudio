...
import com.funnco.funnco.view.viewpager.JazzyViewPager;
...
public class OutlineContainer extends FrameLayout implements Animatable {
	...
	private void init() {
		...
		mOutlinePaint.setStrokeWidth(FunncoUtils.dp2px(getResources(), 2));
//		mOutlinePaint.setColor(getResources().getColor(R.color));
		mOutlinePaint.setColor(getResources().getColor(R.color.color_blue));
		mOutlinePaint.setStyle(Style.STROKE);

		int padding = FunncoUtils.dp2px(getResources(), 10);
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		int offset = FunncoUtils.dp2px(getResources(), 5);

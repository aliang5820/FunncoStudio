package com.funnco.funnco.view.switcher;
...
//		paint.setColor(isOn ? 0xff4bd763 : 0xffe3e3e3);//0xffe67349
		paint.setColor(isOn ? 0xffe67349 : 0xffe3e3e3);
...
//		paint.setColor(isOn ? 0xff4ada60 : 0xffbfbfbf);
		paint.setColor(isOn ? 0xffe67349 : 0xffbfbfbf);
		canvas.drawPath(bPath, paint);

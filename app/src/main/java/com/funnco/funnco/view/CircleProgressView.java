...
public class CircleProgressView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (currentLevel != null) {
            canvas.drawText(currentLevel, mWidth / 2, mHeight / 2 + 50,
                    mTextPaint);
        }
    ...
    private void initPaint() {
        ...
        mBgPaint.setStrokeWidth((float) 12.0);
    ...
    public void setScore(int score) {
        this.score = score;
        if (score == 100) {
            this.currentLevel = ALARM_LEVEL[0];
        } else if (score >= 70 && score < 100) {
            this.currentLevel = ALARM_LEVEL[1];
        } else if (score >= 30 && score < 70) {
            this.currentLevel = ALARM_LEVEL[2];
        } else {
            this.currentLevel = ALARM_LEVEL[3];
        }
        invalidate();
    }
    /***
